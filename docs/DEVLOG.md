...
DoD
1. completed_items.json is machine authority (Option B, DEVLOG stays human-readable)
2. Gate fails naming missing items explicitly
3. Deliberate-failure regression confirmed
4. qa_scope_map.json covers all 63 completed items
5. CI green, QA approved, merged
