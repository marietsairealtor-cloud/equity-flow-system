...
- **`docs/ui-workflows/WORKFLOWS.md`** — **`offer-sent-send`**, **`email-offer-mailto`** plus ACQ variables **`offerSentIdempotencyKeyRefresh`**, **`offerSentIdempotencyKeySend`**, **`offerMailtoUrl`** (**10.13C-D**).
