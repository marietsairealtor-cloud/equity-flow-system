-- 10.8.11I8: Corrective fix for list_user_tenants_v1
-- Joins public.tenants to return workspace_name from tenants.name
-- No schema changes. No new columns. No new RPCs. RPC behavior fix only.
