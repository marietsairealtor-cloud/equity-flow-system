-- 10.14B7B: Forward repair -- update_dispo_packet_v1 RPC
-- Recreates update_dispo_packet_v1 as a standalone single-statement migration.
-- Prerequisite: 10.14B7 (schema columns) and 10.14B7A (prior corrective) already merged.
-- Grants follow in 20260526000002.
