...
SET request.jwt.claim.sub = 'e9000000-0000-0000-0000-000000000001';
SET request.jwt.claim.tenant_id = 'e0000000-0000-0000-0000-000000000001';

-- 6. create_farm_area_v1 succeeds
SELECT is(
  public.create_farm_area_v1('Downtown Core')::json->>'code',
  'OK',
...
SELECT is(
  json_array_length(public.list_farm_areas_v1()::json->'data'->'items'),
  1,
...
SELECT is(
  public.delete_farm_area_v1(
    (SELECT (elem->>'id')::uuid
     FROM json_array_elements(public.list_farm_areas_v1()::json->'data'->'items') AS elem
     LIMIT 1)
  )::json->>'code',
  'OK',
...
SET request.jwt.claim.sub = 'e9000000-0000-0000-0000-000000000002';
SET request.jwt.claim.tenant_id = 'e0000000-0000-0000-0000-000000000002';

SELECT is(
  public.create_farm_area_v1('Tenant2 Area')::json->>'code',
  'OK',
