...
if($pp -match "^docs/proofs/6\.7_share_link_surface_\d{8}T\d{6}Z\.log$"){ return "ALLOW:6.7 proof log" }
  ...
  if($pp -match "^docs/proofs/10\.11A6_deal_properties_write_path_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.11A6 proof log" }
  if($pp -match "^docs/proofs/10\.11A7_deal_pricing_write_path_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.11A7 proof log" }
  if($pp -match "^docs/proofs/10\.11A8_repair_estimate_cleanup_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.11A8 proof log" }
  if($pp -match "^docs/proofs/10\.11A9_pricing_contract_correction_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.11A9 proof log" }
  ...
  if($pp -match "^docs/proofs/10\.12C_intake_submission_outcomes_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.12C proof log" }
  if($pp -match "^docs/proofs/10\.12C1_intake_deal_creation_promotion_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.12C1 proof log" }
  if($pp -match "^docs/proofs/10\.12C2_lead_intake_kpis_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.12C2 proof log" }
  if($pp -match "^docs/proofs/10\.12C3_list_intake_submissions_fix_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.12C3 proof log" }
  if($pp -match "^docs/proofs/10\.12C4_submission_review_outcomes_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.12C4 proof log" }
  ...
  if($pp -match "^docs/proofs/10\.12D1_lead_intake_internal_ui_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.12D1 proof log" }
  ...
  if($pp -match "^docs/proofs/10\.13C-D_offer_ui_send_email_wiring_\d{8}T\d{6}Z\.md$"){ return "ALLOW:10.13C-D proof doc" }
  if($pp -match "^docs/proofs/10\.13E_save_reopen_deal_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.13E proof log" }
  if($pp -match "^docs/proofs/10\.14A_dispo_data_contract_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14A proof log" }
  if($pp -match "^docs/proofs/10\.14B_dispo_share_link_handoff_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B proof log" }
  if($pp -match "^docs/proofs/10\.14B1_buyer_active_status_mutation_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B1 proof log" }
  if($pp -match "^docs/proofs/10\.14B2_dispo_deal_milestone_mutation_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B2 proof log" }
  if($pp -match "^docs/proofs/10\.14B3_property_electrical_plumbing_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B3 proof log" }
  if($pp -match "^docs/proofs/10\.14B4_lead_intake_acq_electrical_plumbing_ui_\d{8}T\d{6}Z\.md$"){ return "ALLOW:10.14B4 proof log" }
  if($pp -match "^docs/proofs/10\.14B4A_acq_health_dot_legend_\d{8}T\d{6}Z\.md$"){ return "ALLOW:10.14B4A proof log" }
  if($pp -match "^docs/proofs/10\.14B4B_next_action_cleanup_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B4B proof log" }
  if($pp -match "^docs/proofs/10\.14B4C_call_log_cleanup_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B4C proof log" }
  if($pp -match "^docs/proofs/10\.14B5_signed_aps_documents_handoff_gate_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B5 proof log" }
  if($pp -match "^docs/proofs/10\.14B5A_generic_deal_documents_remove_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B5A proof log" }
  if($pp -match "^docs/proofs/10\.14B5B_deal_documents_storage_bucket_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B5B proof log" }
  if($pp -match "^docs/proofs/10\.14B5B_deal_documents_storage_bucket_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B5B proof log" }
  if($pp -match "^docs/proofs/10\.14B6_acq_deal_documents_ui_\d{8}T\d{6}Z\.md$"){ return "ALLOW:10.14B6 proof doc" }
  if($pp -match "^docs/proofs/10\.14B7_dispo_buyer_packet_fields_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B7 proof log" }
  ...
  if($pp -match "^docs/proofs/10\.14B8B_expanded_share_packet_fields_\d{8}T\d{6}Z\.log$"){ return "ALLOW:10.14B8B proof log" }
