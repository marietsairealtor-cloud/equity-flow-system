...
& git add docs/handoff_latest.txt generated/schema.sql generated/contracts.snapshot.json docs/truth/write_path_registry.json docs/truth/cloud_migration_parity.json docs/truth/tenant_table_selector.json docs/truth/definer_allowlist.json docs/truth/execute_allowlist.json docs/truth/cloud_migration_parity.json docs/truth/tenant_table_selector.json docs/truth/definer_allowlist.json docs/truth/execute_allowlist.json
