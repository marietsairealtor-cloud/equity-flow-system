...
CREATE OR REPLACE FUNCTION "public"."attach_deal_document_v1"("p_deal_id" "uuid", "p_document_type" "text", "p_storage_path" "text", "p_file_name" "text", "p_mime_type" "text", "p_file_size" bigint) RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."attach_deal_document_v1"("p_deal_id" "uuid", "p_document_type" "text", "p_storage_path" "text", "p_file_name" "text", "p_mime_type" "text", "p_file_size" bigint) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_dispo_kpis_v1"("p_date_from" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_date_to" timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS json
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_dispo_kpis_v1"("p_date_from" timestamp with time zone, "p_date_to" timestamp with time zone) OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."get_draft_deal_v1"("p_draft_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_draft_deal_v1"("p_draft_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_offer_payload_v1"("p_deal_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_offer_payload_v1"("p_deal_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."list_deal_documents_v1"("p_deal_id" "uuid") RETURNS json
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."list_deal_documents_v1"("p_deal_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."list_dispo_dashboard_deals_v1"() RETURNS json
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."lookup_share_token_public_v1"("p_token" "text") RETURNS json
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $_$
DECLARE
...
ALTER FUNCTION "public"."lookup_share_token_public_v1"("p_token" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."refresh_deal_soft_offer_v1"("p_deal_id" "uuid", "p_idempotency_key" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $_$
DECLARE
...
ALTER FUNCTION "public"."refresh_deal_soft_offer_v1"("p_deal_id" "uuid", "p_idempotency_key" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."send_offer_v1"("p_deal_id" "uuid", "p_idempotency_key" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."send_offer_v1"("p_deal_id" "uuid", "p_idempotency_key" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."set_dispo_deal_milestone_v1"("p_deal_id" "uuid", "p_milestone" "text", "p_is_complete" boolean) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."set_dispo_deal_milestone_v1"("p_deal_id" "uuid", "p_milestone" "text", "p_is_complete" boolean) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."trg_draft_deals_promoted_sync_intake_review_v1"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."update_buyer_active_status_v1"("p_buyer_id" "uuid", "p_is_active" boolean) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."update_dispo_packet_v1"("p_deal_id" "uuid", "p_fields" "jsonb") RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $_$
DECLARE
...
ALTER FUNCTION "public"."update_dispo_packet_v1"("p_deal_id" "uuid", "p_fields" "jsonb") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."deal_soft_offers" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "deal_id" "uuid" NOT NULL,
    "assumptions_snapshot_id" "uuid" NOT NULL,
...
COMMENT ON TABLE "public"."deal_soft_offers" IS '10.13A: soft-offer copy rows tied to a deal and the frozen deal_inputs snapshot used for pricing (no orphan FK to deals).';
...
CREATE TABLE IF NOT EXISTS "public"."deals" (
    ...
    "dispo_asking_price" numeric,
    "dispo_intersection" "text",
    "dispo_closing_date" "date",
    "dispo_description" "text",
    "dispo_comparables" "text",
...
COMMENT ON COLUMN "public"."deals"."dispo_asking_price" IS '10.14B7: Buyer-facing asking price for dispo packet';

COMMENT ON COLUMN "public"."deals"."dispo_intersection" IS '10.14B7: Nearest intersection for dispo packet';

COMMENT ON COLUMN "public"."deals"."dispo_closing_date" IS '10.14B7: Target closing date for dispo packet';

COMMENT ON COLUMN "public"."deals"."dispo_description" IS '10.14B7: Deal description for dispo packet';

COMMENT ON COLUMN "public"."deals"."dispo_comparables" IS '10.14B7: Comparable sales notes for dispo packet';

COMMENT ON COLUMN "public"."deals"."dispo_media_url" IS '10.14B7: External media URL for dispo packet. Must be https:// or NULL.';

COMMENT ON COLUMN "public"."deals"."dispo_market_value_estimate" IS '10.14B7: Operator-estimated market value / ARV / comp-supported value';

COMMENT ON COLUMN "public"."deals"."dispo_below_market_override" IS '10.14B7: Optional override for below-market display value. Derived: COALESCE(override, market_value_estimate - asking_price)';
...
CREATE TABLE IF NOT EXISTS "public"."intake_submissions" (
    ...
    CONSTRAINT "intake_submissions_review_outcome_check" CHECK ((("review_outcome" IS NULL) OR ("review_outcome" = ANY (ARRAY['promoted'::"text", 'dismissed_not_interested'::"text", 'dismissed_wrong_number'::"text", 'dismissed_duplicate'::"text", 'dismissed_not_a_fit'::"text", 'rejected_spam'::"text", 'rejected_test'::"text", 'rejected_invalid'::"text"])))),
    CONSTRAINT "intake_submissions_review_status_check" CHECK (("review_status" = ANY (ARRAY['unreviewed'::"text", 'reviewed'::"text"])))
);
...
ALTER TABLE ONLY "public"."deal_soft_offers"
    ADD CONSTRAINT "deal_soft_offers_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "deal_documents_document_type_idx" ON "public"."deal_documents" USING "btree" ("tenant_id", "deal_id", "document_type");

CREATE INDEX "deal_documents_tenant_deal_idx" ON "public"."deal_documents" USING "btree" ("tenant_id", "deal_id");
...
CREATE OR REPLACE TRIGGER "deal_soft_offers_tenant_match" BEFORE INSERT OR UPDATE ON "public"."deal_soft_offers" FOR EACH ROW EXECUTE FUNCTION "public"."check_deal_tenant_match"();
...
CREATE OR REPLACE TRIGGER "trg_draft_deals_promoted_sync_intake_review" AFTER UPDATE OF "promoted_deal_id" ON "public"."draft_deals" FOR EACH ROW EXECUTE FUNCTION "public"."trg_draft_deals_promoted_sync_intake_review_v1"();
...
ALTER TABLE ONLY "public"."deal_documents"
    ADD CONSTRAINT "deal_documents_uploaded_by_fkey" FOREIGN KEY ("uploaded_by") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."deal_soft_offers"
    ADD CONSTRAINT "deal_soft_offers_assumptions_snapshot_id_fkey" FOREIGN KEY ("assumptions_snapshot_id") REFERENCES "public"."deal_inputs"("id");

ALTER TABLE ONLY "public"."deal_soft_offers"
    ADD CONSTRAINT "deal_soft_offers_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "public"."deals"("id") ON DELETE CASCADE;
